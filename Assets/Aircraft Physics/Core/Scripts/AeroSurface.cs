...
{
    [SerializeField] public bool isControlSurface = true;
    [SerializeField] public ControlInputType inputType;
    [SerializeField]  public float inputMultiplyer = 1;
    ...
    public BiVector3 CalculateForces(Vector3 worldAirVelocity, float airDensity, Vector3 relativePosition)
    {
        ...
        float deltaLift = correctedLiftSlope * flapEffectivness * FlapEffectivnessCorrection(_flapAngle) * _flapAngle;
                                          ...
                                          float stallAngleLow)
    {
        ...
        float paddingAngleHigh = Mathf.Deg2Rad * Mathf.Lerp(15, 5, (Mathf.Rad2Deg * _flapAngle + 50) / 100);
        float paddingAngleLow = Mathf.Deg2Rad * Mathf.Lerp(15, 5, (-Mathf.Rad2Deg * _flapAngle + 50) / 100);
